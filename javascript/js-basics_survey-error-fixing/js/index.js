...
firstChoiceButton.addEventListener("click", () => {
  thirdChoiceButton.classList.remove("active-choice");
...
const thirdChoiceButton = document.querySelector('[data-js="choice-button-3"]');
thirdChoiceButton.addEventListener("click", () => {
  thirdChoiceButton.classList.add("active-choice");
  firstChoiceButton.classList.remove("active-choice");
  secondChoiceButton.classList.remove("active-choice");
  console.log("Selected third choice");
});
