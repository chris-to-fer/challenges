...
const indexOfGiraffe = animalStrings.findIndex((e) => e === "giraffe");
...
const anyAnimalEndsWithLetterZ = animalStrings.some((e) => e.endsWith("z"));
...
const sumOfAllAnimalCharacters = calc();
function calc() {
  const text = animalStrings.reduce((a, b) => a + b);
  return text.length;
}
